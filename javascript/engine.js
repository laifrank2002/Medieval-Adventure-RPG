...
var Engine = (
	...
	{	
		...
		return {
			...
			{
				if(page_manager.current_page.handle_key_up) page_manager.current_page.handle_key_up(event);
			},
			handle_key_down: function(event)
			{
				if(page_manager.current_page.handle_key_down) page_manager.current_page.handle_key_down(event);
			},
		}
	}
)();
